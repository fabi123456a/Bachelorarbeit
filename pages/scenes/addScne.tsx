...
const AddScene = (props: { user: User; setScene: (scene: Scene) => void }) => {
  ...
  const addSceneToFS = async (idScene: string) => {
    const response = await fetch("/api/filesystem/FS_uploadScene", {
      ...
      body: JSON.stringify({
        jsonData:
          '{"roomDimensions":{"height":7,"width":50,"depth":50},"models":[{"id":"Boden","position":{"x":0,"y":0,"z":0},"scale":{"x":50,"y":0.001,"z":50},"rotation":{"x":0,"y":0,"z":0},"showXTransform":false,"showYTransform":false,"showZTransform":false,"modelPath":null,"info":"floor","color":"#eee"},{"id":"rechte Wand","position":{"x":25,"y":5,"z":0},"scale":{"x":0.001,"y":10,"z":50},"rotation":{"x":0,"y":0,"z":0},"showXTransform":false,"showYTransform":false,"showZTransform":false,"modelPath":null,"info":"rightWall"},{"id":"linke Wand","position":{"x":-25,"y":5,"z":0},"scale":{"x":0.001,"y":10,"z":50},"rotation":{"x":0,"y":0,"z":0},"showXTransform":false,"showYTransform":false,"showZTransform":false,"modelPath":null,"info":"leftWall"},{"id":"Wand","position":{"x":0,"y":5,"z":-25},"scale":{"x":50,"y":10,"z":0.001},"rotation":{"x":0,"y":0,"z":0},"showXTransform":false,"showYTransform":false,"showZTransform":false,"modelPath":null,"info":"behindWall"}],"fbx_models":[]}', // leere scene daten
        sceneID: idScene,
      }),
    });
    const result = await response.json();
